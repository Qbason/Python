...
class Application(tkinter.Frame):
    ...
    def create_widgets(self):
        ...
        self.single["command"] = None # run a code....
        self.single["fg"] = "green"
        
        self.single.pack(fill="x",ipadx=10,ipady=10)

        self.multi = tkinter.Button(self)
        self.multi["text"] = "MultiPlayer"
        self.multi["command"] = None # run a code....
        self.multi["fg"] = "green"
        self.multi.pack(fill="x",ipadx=10,ipady=10)

        self.options = tkinter.Button(self)
        self.options["text"] = "Options"
        self.options["command"] = None # run a code....
        self.options["fg"] = "green"
        self.options.pack(fill="x",ipadx=10,ipady=10)
        ...
        self.quit["text"] = "QUIT"
        self.quit["fg"] = "red"
        self.quit.pack(fill="x",ipadx=10,ipady=10)
